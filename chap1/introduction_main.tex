...
\begin{figure}[ht!] % supposedly places it here ...
  \centering
  \includegraphics[width=0.6\linewidth]{test_image_communism}
  \caption[This is the short caption for List of Figures]{A test figure.  This caption is huge, but in the list of figures only the smaller version in the square brackets will appear.\index{communism il-king}}
  \label{fig:test1}
\end{figure}
...
\begin{figure}[!ht]
    \centering
    \subbottom[communism]{\includegraphics[width=0.3\textwidth]{test_image_communism}}\qquad
    \subbottom[More communism]{\includegraphics[width=0.3\textwidth]{test_image_communism}}%
    \caption[Short Caption]{The same super communism. Two times.}        
    \label{fig:test2}
\end{figure}
