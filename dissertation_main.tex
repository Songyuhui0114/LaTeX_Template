...
%%      https://github.com/Songyuhui0114/LaTeX_Template/tree/master
%%
%% In case of any difficulties please contact Bachelor YuHui Song by songyuhui0114@gmail.com
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%% Note that packages may already be loaded from the cup (and memoir) classes.
